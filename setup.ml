...
(* OASIS_START *)
(* DO NOT EDIT (digest: b93ceef4b7fe22b0af7a50e3ad910e71) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_kernel", []))];
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.0.2");
          ...
          copyrights = [];
          maintainers =
            ["Carmelo Piccione (carmelo.piccione+covar@gmail.com)"];
          authors = ["Carmelo Piccione"];
          homepage = Some "https://github.com/struktured/ocaml-covar";
          synopsis = "Covariance functions, in OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "Covariance (kernel) functions for machine learning, in OCaml"
              ];
          categories = [];
          ...
          sections =
            [
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/struktured/ocaml-covar.git";
                      src_repo_browser =
                        Some "https://github.com/struktured/ocaml-covar";
               ...
               Flag
                 ({
                     cs_name = "install_tests";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some "Install test library (for developers)";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/lib/kernels";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "covar";
                           FindlibPackage ("lacaml", None);
                           FindlibPackage ("gsl", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "install_tests", true)
                        ];
                      bs_path = "src/test";
                      bs_compiled_object = Best;
                      bs_build_depends =
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_kernel.ml"});
               Test
                 ({
                     cs_name = "test_kernel";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_kernel"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\244t\179*\159\223\238?\151_\205\136\201\025O\173";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
