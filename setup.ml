...
(* OASIS_START *)
(* DO NOT EDIT (digest: a7228e6fa3bfd101946c014e831d2ca3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Online Multi-resolution Kernels, In OCaml";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\020\146\218z\203\243Q\141`\012B}\218\146\199\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
